/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config ../../wrangler.toml` (hash: 0022afcbe696ed86e859155340d8b119)
// Runtime types generated with workerd@1.20251011.0 2026-04-05 
declare namespace Cloudflare {
	...
	interface Env {
		...
		SKYGEMS_PROVIDER_PRIMARY: string;
		SKYGEMS_PROVIDER_SECONDARY: string;
		SKYGEMS_GENERATE_EXECUTION_MODE: string;
		SKYGEMS_ENABLE_DEV_BOOTSTRAP: string;
		DEV_BOOTSTRAP_SECRET: string;
		XAI_API_KEY: string;
		SKYGEMS_ARTIFACTS: R2Bucket;
		SKYGEMS_DB: D1Database;
		GENERATE_QUEUE: Queue;
		REFINE_QUEUE: Queue;
		SPEC_QUEUE: Queue;
		AI_GATEWAY: Ai;
		DESIGN_PIPELINE_WORKFLOW: Workflow<Parameters<import("./src/index").DesignPipelineWorkflow['run']>[0]['payload']>;
	}
}
