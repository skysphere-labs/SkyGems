 ...
 */
const STORAGE_KEYS = {
  METADATA: 'jewel_designs_metadata',
  GENERATED: 'jewel_designs_generated',
  LIKED: 'jewel_designs_liked',
};
...
class StorageManager {
  ...
  private saveMetadata(): void {
    try {
      ...
      localStorage.setItem(STORAGE_KEYS.METADATA, JSON.stringify(data));
    } catch (error) {
